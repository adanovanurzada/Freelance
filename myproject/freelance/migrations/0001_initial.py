    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('client', 'Client'), ('freelancer', 'Freelancer')], max_length=20)),
                ...
                ('skills', models.ManyToManyField(blank=True, related_name='users', to='freelance.skill')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='freelance.category')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to=settings.AUTH_USER_MODEL)),
                ('skills_required', models.ManyToManyField(related_name='projects', to='freelance.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Offer',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='offers', to='freelance.project')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
